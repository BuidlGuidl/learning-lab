      ...
      cards: [
        ...
        },
        {
          ...
          rubricConcepts: [
            ...
            "the address is public and visible before signing, so checking it (or sending a tiny test amount first) is the only real protection",
          ],
          hints: [
