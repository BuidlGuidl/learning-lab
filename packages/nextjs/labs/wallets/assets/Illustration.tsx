        ...
        >
          <div className="modal-box flex h-auto max-h-none w-auto max-w-none flex-col items-end gap-2 overflow-visible bg-transparent p-0 shadow-none">
            ...
            <Image
              ...
              width={width}
              height={height}
              className="h-auto max-h-[calc(100dvh-4.5rem)] w-auto max-w-[calc(100vw-1rem)] rounded-xl object-contain shadow-2xl sm:max-h-[calc(100dvh-6.5rem)] sm:max-w-[calc(100vw-3rem)]"
              unoptimized
            />
          </div>
