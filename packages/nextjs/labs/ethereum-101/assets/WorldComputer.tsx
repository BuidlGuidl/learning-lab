    ...
    <div className="flex flex-col gap-4 text-lab-code-panel-text">
      <div className="flex items-center justify-between gap-3">
        <span className="inline-flex items-center gap-2 rounded-full border border-lab-code-panel-border bg-lab-code-panel-tint px-3 py-1 font-mono text-xs">
          <span className="text-lab-code-panel-muted">shared state</span>
          <strong className="font-semibold text-lab-code-panel-text">STATE {consensus}</strong>
        </span>
        <button
          type="button"
          onClick={reset}
      ...
      <p className="m-0 min-h-[2.5rem] text-sm leading-relaxed text-lab-code-panel-muted">{caption}</p>
      ...
      <div className="flex flex-wrap gap-2.5">
        ...
        <button
          ...
          onClick={tamper}
          disabled={busy}
          className="inline-flex items-center gap-2 rounded-lg border border-lab-code-panel-border bg-lab-code-panel-tint px-4 py-2.5 text-sm font-semibold text-lab-code-panel-text transition hover:border-lab-code-panel-accent disabled:opacity-50"
        >
          Tamper a node
        </button>
      </div>

      <div className="flex items-center gap-2 rounded-lg border border-lab-code-panel-border bg-lab-code-panel-tint px-3 py-2 text-xs leading-snug text-lab-code-panel-muted">
        <LightBulbIcon className="h-4 w-4 shrink-0 text-lab-code-panel-accent" />
        <span>
          <strong className="font-semibold text-lab-code-panel-text">Tip</strong> — click any node to drop it offline,
          then bring it back.
        </span>
      </div>
    </div>
